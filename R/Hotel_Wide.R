...
#'
#' '\code{Hotel_Wide}', a 'Wide format', is a preprocessing data of the publicly available 'Hotel 1' data introduced in Bodea et al. (2009).
#'
...
#'
#'
#' @format '\code{Hotel_Wide}': A data frame with 1,100 rows and 22 variables:
#' \describe{
...
#'   \item{Purchased_Prod_Code}{Unique number of products associated with room type.}
#'   \item{Exposed_Choice_Set}{Choice set exposed to individual}
#'   \item{Exposed_Choice_Set_Code}{Unique number of choice sets associated with Exposed_Choice_Set}
#'   \item{Price_1 ~ Price_10}{The average nightly rate the customer pays in USD (e.g., $199.99).
